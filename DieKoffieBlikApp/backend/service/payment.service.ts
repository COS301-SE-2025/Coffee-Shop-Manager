...
class PaymentService {
  ...
  private static MERCHANT_KEY =
    process.env.PAYFAST_MERCHANT_KEY || "46f0cd694581a"; // Fallback to sandbox
  private static PAYFAST_URL =
    process.env.PAYFAST_URL || "https://sandbox.payfast.co.za/eng/process"; // Fallback to sandbox
