    ...
    <>
      ...
      <div>
        ...
        <input
          ...
          } rounded-lg bg-amber-50 dark:bg-amber-900/30 text-brown-800 dark:text-amber-100 placeholder:text-amber-400 dark:placeholder:text-amber-700 focus:outline-none focus:ring-2 ${
      ...
      <div>
        ...
        <input
          ...
          className={`w-full px-4 py-2.5 border ${
            ...
            emailError2 ? "focus:ring-red-400" : "focus:ring-amber-600"
          }`}
        ...
        <div className="relative">
          <input
            ...
            className={`w-full px-4 py-2.5 border ${
              ...
              passwordError ? "focus:ring-red-400" : "focus:ring-amber-600"
            }`}
        ...
        <div className="relative">
          <input
            ...
            className={`w-full px-4 py-2.5 border ${
              ...
              passwordError2 ? "focus:ring-red-400" : "focus:ring-amber-600"
            }`}
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-2.5 border ${
              ...
              firstNameError ? "focus:ring-red-400" : "focus:ring-amber-600"
            }`}
          />
          {firstNameError && (
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-2.5 border ${
              ...
              lastNameError ? "focus:ring-red-400" : "focus:ring-amber-600"
            }`}
          />
          {lastNameError && (
            <p className="mt-1 text-sm text-red-500 dark:text-red-400">
      ...
      <div>
        ...
        <input
          ...
          className={`w-full px-4 py-2.5 border ${
            ...
            phoneError ? "focus:ring-red-400" : "focus:ring-amber-600"
          }`}
        />
        {phoneError && (
          <p className="mt-1 text-sm text-red-500 dark:text-red-400">
        ...
        <input
          ...
          className={`w-full px-4 py-2.5 border ${
            dobError
              ? "border-red-400 dark:border-red-600"
              : "border-amber-200 dark:border-amber-900"
          } rounded-lg bg-amber-50 dark:bg-amber-900/30 text-brown-800 dark:text-amber-100 focus:outline-none focus:ring-2 ${
            dobError ? "focus:ring-red-400" : "focus:ring-amber-600"
          }`}
        />
        <p className="text-xs text-amber-700 dark:text-amber-400 mt-1">
        ...
        <div className="w-full max-w-md p-6 md:p-8 bg-white dark:bg-[#1a1310] rounded-xl shadow-lg border border-amber-200 dark:border-amber-900 relative">
          ...
          <div className="mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-white dark:bg-amber-900/30 text-gray-700 dark:text-amber-100 border border-amber-200 dark:border-amber-900 rounded-lg px-4 py-2.5 font-medium hover:bg-amber-50 dark:hover:bg-amber-900/50 transition duration-200 shadow-sm"
            >
            ...
            <div className="relative my-6">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t border-amber-200 dark:border-amber-900"></div>
              </div>
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white dark:bg-[#1a1310] text-amber-700 dark:text-amber-400">
