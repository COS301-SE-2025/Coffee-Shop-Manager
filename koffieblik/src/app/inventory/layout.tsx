...
export default function InventoryLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="h-screen flex flex-col" style={{ backgroundColor: 'var(--primary-1)' }}>

      {/* ✅ Top Navbar */}
      <Navbar />

      {/* ✅ Main content: full height after navbar */}
      <div className="flex flex-1 overflow-hidden" style={{ color: 'var(--primary-3)' }}>
        ...
        <div className="flex-1 overflow-y-auto p-6" style={{ backgroundColor: 'var(--primary-2)' }}>
